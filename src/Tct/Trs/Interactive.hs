...
loadX :: T.Declared TrsProblem TrsProblem => (TrsProblem -> TrsProblem) -> FilePath -> IO ()
...
loadTrs, loadDC, loadDCI, loadRC, loadRCI :: T.Declared TrsProblem TrsProblem => FilePath -> IO ()
loadTrs = loadX id
